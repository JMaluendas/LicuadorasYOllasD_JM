...
$Ben[Codigo]
  ...
  <ul class='dropdown-menu'>
    <li><a class='btn btn-info me-2' href='Productos.php'>Productos</a></li>
...
<div>
  <img src="html/images/1 imagen.png" width="200" height="200" style="float: left">
</div>
<div>
...
<table width="60%" align="center" border="0" >
  <tbody>
    <tr>
      <td><input type="text" size="8%" class="btn btn-info" value="Id Producto" /></td>
      <td><input type="text" size="49%" class="btn btn-info" value="Nombre Producto" /></td>
      <td><input type="text" size="8%" class="btn btn-info" value="Cantidad" /></td>
      <td><input type="text" size="8%" class="btn btn-info" value="Valor Ingreso" /></td>
      <td><input type="text" size="8%" class="btn btn-info" value="Descuento" /></td>
      <td><input type="text" size="8%" class="btn btn-info" value="Valor Venta" /></td>
    </tr>
  </tbody>
</table>
			  <?php
